...
void test_entferne_kfz_warteschlange_normal(){
    ...
    p_parkhaus->p_erster_in_der_warteschlange->p_naechster = p_kfz2;
    p_parkhaus->p_erster_in_der_warteschlange->p_naechster->p_naechster = p_kfz3;

    entferne_kfz_warteschlange(p_parkhaus);
    assert(p_parkhaus->p_erster_in_der_warteschlange == p_kfz2);
    assert(p_parkhaus->p_erster_in_der_warteschlange->p_naechster == p_kfz3);
    assert(p_kfz1->p_naechster == NULL);
