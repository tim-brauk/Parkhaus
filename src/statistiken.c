...
float berechne_durchschnitt_auslastung(const SimulationsStats *p_statistik)
{
    ...
    {
        return p_statistik->p_auslastung_pro_zeitschritt[p_statistik->durchlaufene_zeitschritte]; //beim ersten durchlauf wird der Return genutzt somit wird spätere Division durch 0 vermieden
    }
